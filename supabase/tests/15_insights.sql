...
values ('a5000000-0000-0000-0000-000000000001', auth.uid(), auth.uid(), 'ledger', 'checking', 'A Checking', 'EUR', 1000);
insert into accounts (id, owner_id, created_by, kind, subtype, name, currency, opening_balance)
...
values (auth.uid(), auth.uid(), 'a5000000-0000-0000-0000-000000000001', 'c5000000-0000-0000-0000-000000000001', -60, 'EUR', now() - interval '3 days');
insert into transactions (owner_id, created_by, account_id, category_id, amount, currency, occurred_at)
values (auth.uid(), auth.uid(), 'a5000000-0000-0000-0000-000000000001', 'c5000000-0000-0000-0000-000000000001', -40, 'EUR', now() - interval '2 days');
insert into transactions (owner_id, created_by, account_id, category_id, amount, currency, occurred_at)
values (auth.uid(), auth.uid(), 'a5000000-0000-0000-0000-000000000001', 'c5000000-0000-0000-0000-000000000002', 1000, 'EUR', now() - interval '2 days');

-- 1. spending_by_category sums two expenses in the same category.
select is(
  (select total from spending_by_category('total', current_date - 10, current_date)
...
select is(
  (select total from spending_by_category('household', current_date - 10, current_date)
   where category_id = 'c5000000-0000-0000-0000-000000000001'),
  100.0000::numeric,
...
select create_transfer('a5000000-0000-0000-0000-000000000001', 'a5000000-0000-0000-0000-000000000002', 200);
...
select is(
  (select sum(income) from income_expense_series('total', current_date - 10, current_date, 'weekly')),
  1000.0000::numeric,
  'income_expense_series totals income across buckets, excluding the transfer'
);

select is(
  (select sum(expense) from income_expense_series('total', current_date - 10, current_date, 'weekly')),
  100.0000::numeric,
...
insert into transactions (owner_id, created_by, account_id, category_id, amount, currency, occurred_at)
values (auth.uid(), auth.uid(), 'a5000000-0000-0000-0000-000000000001', 'c5000000-0000-0000-0000-000000000001', -30, 'GBP', now());
...
select create_transfer('a5000000-0000-0000-0000-000000000001', 'a5000000-0000-0000-0000-000000000003', 500);
...
insert into balance_snapshots (account_id, as_of, value, currency, created_by)
values ('a5000000-0000-0000-0000-000000000003', current_date, 600, 'EUR', auth.uid());
