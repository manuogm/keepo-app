...
private struct NotificationPreviewCard: View {
    var body: some View {
        VStack(alignment: .leading, spacing: AppTheme.Spacing.s) {
            ...
            // Generated by the same function that writes the real thing —
            // see `CaptureNotificationCopy.sample` for why inventing the
            // wording here was worse than it looked.
            Text(CaptureNotificationCopy.sample.title)
                .font(AppTheme.Typography.bodyEmphasis)
                .foregroundStyle(AppTheme.Palette.textPrimary)
            Text(CaptureNotificationCopy.sample.body)
                .font(AppTheme.Typography.caption)
                .foregroundStyle(AppTheme.Palette.textSecondary)
        ...
        .accessibilityLabel("Example notification. \(CaptureNotificationCopy.sample.title). "
            + CaptureNotificationCopy.sample.body)
    }
}
